...
| 7 | `mrtr/` | `tool-call` | `input_required`, capability check, form elicitation, new retry ID, exact state echo, incomplete-response re-elicitation, accept/decline/cancel, signed state tamper/expiry/binding, cross-replica retry | 16 | 2,5,6 | Critical |
