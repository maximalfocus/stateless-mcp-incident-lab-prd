...
| 9 | `cache/` | `function`, `http` | Mandatory hints on the six cacheable operations and on no others, key method+params+cursor, TTL freshness, public/private scope, no MRTR caching, stale-on-error warning, deterministic pages | 10 | 4,5,7 | Medium |
